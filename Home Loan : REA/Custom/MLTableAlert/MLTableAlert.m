...
-(void)show
{
	...
	self.titleLabel.textColor = [ColorUtilities colorWithHexString:@"07456b"];
//	self.titleLabel.shadowColor = [[UIColor blackColor] colorWithAlphaComponent:0.75];
//	self.titleLabel.shadowOffset = CGSizeMake(0, -1);
	self.titleLabel.font = [UIFont fontWithName:@"Oxygen-Bold" size:18.0];
	...
	if (self.cancelButtonTitle)
	{
		...
		self.cancelButton.titleLabel.font = [UIFont fontWithName:@"Oxygen" size:17.0];
...
//		self.cancelButton.titleLabel.shadowColor = [[UIColor blackColor] colorWithAlphaComponent:0.75];
		...
		[self.cancelButton setTitleColor:[ColorUtilities colorWithHexString:@"07456b"] forState:UIControlStateNormal];
